...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div
        className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.2]  flex items-center justify-center absolute
      top-0 left-0"
      >
      ...
      justify-center"
        ...
        mb-4 text-sm md:text-lg lg:text-2xl"
          >
            Hi, I&apos;m Oyshe, a React.js Developer based in Bangladesh.
          </p>
